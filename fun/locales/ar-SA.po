...
class Fun(Cog):
    ...
    async def eightball(self, ctx, *, question: str):
        ...
        embed = discord.Embed(title='I can see your answer', color=discord.
            Color.blue())
    ...
    async def mock(self, ctx, *, text: str):
        """Mock a given text."""
        mocked_text = ''.join(random.choice([char.upper(), char.lower()]) for
            char in text)
    ...
    async def memeify(self, ctx, *, text: str):
        ...
        memeified_text = ' '.join([(char.upper() if i % 2 == 0 else char.
            lower()) for i, char in enumerate(text)])
