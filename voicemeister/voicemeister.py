    ...
    if option == None:
     ...
     async with self.bot.db.cursor() as cursor: 
      ...
      if check is not None:
        ...
        category = await ctx.guild.create_category("discord.gg/htc")
