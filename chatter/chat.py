...
log = logging.getLogger("red.star.chatter")
...
class Chatter(Cog):
    ...
    models = [ENG_SM, ENG_MD, ENG_LG, ENG_TRF, FR_LG, FR_TRF]
    ...
    async def chatter_model(self, ctx: commands.Context, model_number: int):
        ...
        4: Large FR (Requires additional setup)
        5. Accurate FR (Requires additional setup)
        """
