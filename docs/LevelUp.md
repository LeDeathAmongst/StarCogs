...
**Description:** View Weekly Leaderboard

**Usage:** `<@1275521742961508432>weekly`

### lastweekly

**Description:** View Last Week's Leaderboard

**Usage:** `<@1275521742961508432>lastweekly`

### weeklyset

**Description:** Configure Weekly LevelUp Settings
...
**Description:** Set hour for weekly stats reset

**Usage:** `<@1275521742961508432>weeklyset hour`

### weeklyset reset

**Description:** Reset the weekly leaderboard manually and announce winners
...
**Description:** Set day for weekly stats reset
0 = Monday
1 = Tuesday
2 = Wednesday
3 = Thursday
...
**Description:** View the LevelUp leaderboard

**Usage:** `<@1275521742961508432>leveltop`

### roletop

**Description:** View the leaderboard for roles
...
**Usage:** `<@1275521742961508432>profile`

### prestige

**Description:** Prestige your rank!
...
**Description:** Set a color for your username
...
**Description:** Reward a good noodle

**Usage:** `<@1275521742961508432>stars`

### startop

**Description:** View the Star Leaderboard

**Usage:** `<@1275521742961508432>startop`

### starset

**Description:** Configure LevelUp Star Settings
...
**Description:** Owner Only LevelUp Settings
...
**Description:** Toggle ignoring bots for XP and profiles
...
**Description:** Enable internal API for parallel image generation
...
**Usage:** `<@1275521742961508432>levelowner internalapi`

### levelowner cache

**Description:** Set the cache time for user profiles
...
**Description:** Admin Only Data Commands
...
**Description:** Import data from Fixator's Leveler cog
...
**Description:** Import levels and exp from Polaris
...
**Description:** Import levels and exp from AmariBot
**Arguments**
...
**Usage:** `<@1275521742961508432>leveldata importamari`

### leveldata importmalarne

**Description:** Import levels and exp from Malarne's Leveler cog
...
**Description:** Set a user to a specific prestige level

Prestige roles will need to be manually added/removed when using this command

**Usage:** `<@1275521742961508432>levelset setprestige`

### levelset levelnotify

**Description:** Send levelup message in the channel the user is typing in
...
**Usage:** `<@1275521742961508432>levelset messages rolebonus`

### levelset messages length

**Description:** Set minimum message length for XP
...
**Description:** Set LevelUp log channel
...
**Description:** Level up alert messages
...
**Description:** Set the DM a user gets when they level up (Without recieving a role).
...
**Usage:** `<@1275521742961508432>levelset levelupmessages dm`

### levelset levelupmessages msgrole

**Description:** Set the message sent when a user levels up and recieves a role.
...
**Usage:** `<@1275521742961508432>levelset levelupmessages dmrole`
